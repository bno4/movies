...
for (let i = 0; i < allMovies.length; i++) {
 axios.get(`https://api.themoviedb.org/3/movie/${allMovies[i]}?api_key=b7b3ec164d57a72e901bc1765d723836&language=fr-FR`).then((res)=> setListData((listData) => [...listData, res.data]))
}
},[])
